...
| **Live Courtroom** | WebRTC video rooms, roles (Judge/Prosecution/Defense/Witness…), WS signaling relay, transcript, judge-controlled phases, transcript download | `scripts/courtroom_manager.py`, `courtroom.*` |
