...
<div class="decision-hero">
  ...
  <h2>Kolkata_Train_ticket.jpg</h2>
  <p>The case involves a passenger ticket for a flight from Sealdah to Naihati Junction, with a specified journey time and mode of payment. The ticket is for a passenger named Pilot, and the airline is Airline. The case is related to customs and import/export regulations.</p>
...
flowchart TD
  ...
  N2 --> N3
  N4["Step 5: Legal category<br/>Legal category is one of: Company/Winding Up, Constitutional/Writ, Criminal/Violent, Customs/Import-Export, Excise/Tax, General Civil<br/>Case: General Civil<br/>Answer: Yes"]:::decision
  N3 --> N4
...
<div class="step-card">
  ...
  <div class="step-body">
    ...
    <div class="step-meta">Case value: <strong>General Civil</strong> | Result: <strong>Yes</strong></div>
  </div>
</div>
<div class="step-card">
