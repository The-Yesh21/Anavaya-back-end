...
<div class="decision-hero">
  ...
  <p>Cipla Limited challenged a tax order claiming that a chemical intermediate called BMS is not a marketable good. The Assistant Collector of Central Excise argued that the product is excisable regardless of its marketability. The court examined whether the product must be known to the market to attract excise duty.</p>
