...
<div class="decision-hero">
  ...
  <h2>ANV-2026-0019_whole_case</h2>
  <p>This case file brings together 6 documents (6 × Other) and is assessed as a single matter of Excise/Tax with no injury indicated. The evidence on record consists of “03_Exhibit_P2_Bank_Transfers.png” (Other; Excise/Tax); “04_Exhibit_P3_Disputed_Invoices.png” (Other; Excise/Tax); “05_Exhibit_P4_Bank_Statement.png” (Other; General Civil); “06_Exhibit_P5_GST_Certificate.png” (Other; Excise/Tax); “07_Exhibit_P6_Forensic_Report.png” (Other; Excise/Tax); “09_Evidence_Booklet.pdf” (Other; Constitutional/Writ). Cross-comparison finds 4 corroborating links between the documents (shared dates, places or parties), which strengthens the consistency of the record. For example, “03_Exhibit_P2_Bank_Transfers.png” and “09_Evidence_Booklet.pdf” share parties. “05_Exhibit_P4_Bank_Statement.png” currently stands alone — no other document shares a date, place or party with it, so further supporting evidence would strengthen the case.</p>
...
Raw DOT file: `case_priority_system/decision_graphs\ANV-2026-0019_whole_case_decision_path.dot`
